...
const Login = (props) => {
    ...
    const handleSignUp=()=>
    {
        navigate(`/signup${props.mode.toLowerCase()}`)
    }
  return (
    <div>
                ...
                <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div className="bg-dark rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <i className="fa-solid fa-user-pen mx-3"></i>
                            <h3 className='text-center'>Log In As {props.mode}</h3>
                        </div>
                        ...
                        <p className="text-center mb-0" style={{color:'lightgrey'}} >Don't have an Account? 
                        <a to="" className='mx-2' style={{color:'red',cursor:'pointer'}} onClick={handleSignUp}>Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
